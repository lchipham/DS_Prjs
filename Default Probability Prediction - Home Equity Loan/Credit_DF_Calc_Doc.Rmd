...
Greeting! I'm Linh Chi, owner of this app. This credit risk calculator takes customer's info as input, and output default probability as output. In the process, the percentile of this specific customer's default prob is calculated, based on which the bank will be able to decide if the customer is qualified for loan (according to the bank's loan acceptance rate).
...
ui <- fluidPage(
    # Application title
    titlePanel(h3("Credit Risk Calculator", align = "center")),
    h5(tags$a(href = "https://github.com/lchipham", "Source code: Linh-Chi Pham"), align = "center"),
...
server <- function(input, output) {
  default_prob <- function(X1 = 16, X2 = 1, X3 = 1, X4 = 179.77, X5 = 18608, X6 = 2, X7 = 21, pct = TRUE, plotDT = TRUE) {
    lm_mod <- -2.37457089 + 0.05227723*X1 + 0.75513589*X2 + 0.63659597*X3 - 0.00509945*X4 - 0.00001965*X5 + 0.16747460*X6 - 0.01794787*X7
